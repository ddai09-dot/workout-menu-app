...
TASK20_D2I_PHASE1_TIMEOUT_SECONDS=1200 TASK20_D2I_PHASE2_TIMEOUT_SECONDS=600 TASK20_D2I_LOG_DIR="$ROOT/app/build/task20_d2i_local_data_reset" \
  bash tools/run_task20_d2i_ios_ui_acceptance.sh "$ROOT/app"
TASK20_D2G_DRIVE_TIMEOUT_SECONDS=1500 TASK20_D2G_LOG_DIR="$ROOT/app/build/task20_d2g_my_page_settings" \
