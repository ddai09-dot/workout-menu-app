...
def main() -> int:
    if len(sys.argv) != 2:
        raise SystemExit("usage: task20_d2i_prepare_ui_acceptance.py <app-dir>")
    ...
    source_files = {
        ...
        repo_root / "tools" / "task20_d2i_test_support.dart":
            app_dir / "integration_test" / "task20_d2i_test_support.dart",
        repo_root / "tools" / "task20_d2i_local_reset_prepare_test.dart":
            app_dir / "integration_test" / "task20_d2i_local_reset_prepare_test.dart",
        repo_root / "tools" / "task20_d2i_local_reset_verify_test.dart":
            app_dir / "integration_test" / "task20_d2i_local_reset_verify_test.dart",
        repo_root / "tools" / "task20_d2i_driver.dart":
            app_dir / "test_driver" / "task20_d2i_driver.dart",
    }
    ...
    print(f"Prepared Task 20-D2I test overlay in {app_dir}")
    return 0
