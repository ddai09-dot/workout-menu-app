...
# multi-hour D2A/D2C/D2D/D2E/D2F/D2G/D2H/D2I regression chain. This lane is a
# diagnostic accelerator only; the normal PR workflow remains the acceptance
# authority and must still pass on the same exact PR head.
...
# Build the unchanged v0.9.22 app and establish the deterministic regular-size
# simulator selection consumed by D2K.
