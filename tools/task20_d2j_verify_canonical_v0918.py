...
def th(root,parts):
 ...
 return d.hexdigest()
def main():
 if len(sys.argv)!=2: raise SystemExit('Usage: task20_d2j_verify_canonical_v0918.py <app-root>')
 ...
 for needle,text in [('version: 0.9.18+36',pub),('実装基盤 v0.9.18',readme),('現在のプロジェクト版：`0.9.18+36`',matrix),('| 0.9.18 |',matrix),('D-026',decision),('休憩を終了する',decision),('次の種目へ',decision)]:
 ...
 print(json.dumps({'status':'PASS','canonical_package':'implementation-v0.9.18.zip','app_version':'0.9.18+36','parent_canonical_version':'0.9.17+35','expected_flutter_test_count':56,'schema_version':9,'schema_table_count':75,'tree_hashes':hashes,'product_lib_changed_from_v0_9_17':False,'tests_changed_from_v0_9_17':False,'schema_changed_from_v0_9_17':False,'assets_changed_from_v0_9_17':False,'d2j_acceptance_status':'PENDING_EXACT_CURRENT_HEAD_CI_AND_ARTIFACT_AUDIT','task20_d2_fully_verified':False},sort_keys=True)); return 0
